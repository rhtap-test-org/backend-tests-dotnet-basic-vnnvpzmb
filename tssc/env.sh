...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/backend-tests-dotnet-basic-vnnvpzmb:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/backend-tests-dotnet-basic-vnnvpzmb-gitops
